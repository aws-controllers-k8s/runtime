...
// NewAWSConfig provides a mock function with given fields: _a0, _a1, _a2, _a3, _a4, _a5, _a6
func (_m *ServiceController) NewAWSConfig(_a0 context.Context, _a1 v1alpha1.AWSRegion, _a2 v1alpha1.AWSRegion, _a3 *string, _a4 v1alpha1.AWSResourceName, _a5 schema.GroupVersionKind, _a6 map[string]string) (aws.Config, error) {
	...
	var r0 aws.Config
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, v1alpha1.AWSRegion, v1alpha1.AWSRegion, *string, v1alpha1.AWSResourceName, schema.GroupVersionKind, map[string]string) (aws.Config, error)); ok {
		return rf(_a0, _a1, _a2, _a3, _a4, _a5, _a6)
	}
	if rf, ok := ret.Get(0).(func(context.Context, v1alpha1.AWSRegion, v1alpha1.AWSRegion, *string, v1alpha1.AWSResourceName, schema.GroupVersionKind, map[string]string) aws.Config); ok {
		r0 = rf(_a0, _a1, _a2, _a3, _a4, _a5, _a6)
	} else {
		r0 = ret.Get(0).(aws.Config)
	}

	if rf, ok := ret.Get(1).(func(context.Context, v1alpha1.AWSRegion, v1alpha1.AWSRegion, *string, v1alpha1.AWSResourceName, schema.GroupVersionKind, map[string]string) error); ok {
