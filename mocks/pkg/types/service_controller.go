...
// BindControllerManager provides a mock function with given fields: _a0, _a1, _a2
func (_m *ServiceController) BindControllerManager(_a0 context.Context, _a1 manager.Manager, _a2 config.Config) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, manager.Manager, config.Config) error); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Error(0)
	}
