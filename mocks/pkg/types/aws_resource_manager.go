...
// OnAdopted provides a mock function with given fields: _a0, _a1
func (_m *AWSResourceManager) OnAdopted(_a0 context.Context, _a1 types.AWSResource) (types.AWSResource, error) {
	ret := _m.Called(_a0, _a1)

	if len(ret) == 0 {
		panic("no return value specified for OnAdopted")
	}
