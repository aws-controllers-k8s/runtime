...
func (_m *FieldExportReconciler) GetFieldExportsForResource(_a0 context.Context, _a1 schema.GroupKind, _a2 pkgtypes.NamespacedName) ([]v1alpha1.FieldExport, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetFieldExportsForResource")
	}
...
func (_m *FieldExportReconciler) SecretResourceVersion(_a0 context.Context, _a1 *v1alpha1.SecretKeyReference, _a2 string) (string, error) {
	ret := _m.Called(_a0, _a1, _a2)
